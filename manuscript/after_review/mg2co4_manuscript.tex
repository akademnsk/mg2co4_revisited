...
%Добавить сюда методику по Бадеру Раману. 
...
%Тут нужно сделать соответствующие изменения названий фаз, чтобы был вадслеит, рингвудит и пр.
} \label{E-P}
\end{figure} 
...
\begin{figure}[H]
	...
	\caption{Phonon dispersion curves of Mg$_2$CO$_4$-$Pnma$ at 50 GPa (a) and Mg$_2$CO$_4$-$P2_1/c$ at 75 GPa (b).
		%! К этим дисперсионным кривым нужно ещё обязательно добавить дисперсионные кривые при 0 ГПа для обоих фаз.
...
%!Необходимо увеличить шрифты и сами картинки (можно рисунки поближе сделать, чтобы уменьшить размер)
\end{figure}
...
%! У Ланиэля еще указывается The isosurface is plotted fora value of 0.2 e A3. Нам тоже нужно указать для какого сечения мы строим распрпделение электронной плотности}
\end{figure}
...
%! Тут надо вместо многоточия вставить значения
...
%! Ту  нужно поправить давления где разница равна 500 К
